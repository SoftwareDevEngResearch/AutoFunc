from get_match_factor import match
from simple_counter import count_stuff, find_top_thresh
...
if __name__ == "__main__":
    ...
    file1 = os.path.join(script_dir, args.learning_file)
    ...
    test_file = os.path.join(script_dir, args.test_file)
...
# Working input:
# python main.py -lf /Users/alex/Documents/GitHub/AutoFunc/autofunc/assets/bladeCombined.csv -tf /Users/alex/Documents/GitHub/AutoFunc/autofunc/assets/jigsawQuery.csv
